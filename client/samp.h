...
private:
	...
	DWORD dwSAMPAddr;
	struct stSAMP* g_SAMP = nullptr;
	struct stPlayerPool* g_Players = nullptr;
	struct stVehiclePool* g_Vehicles = nullptr;
	struct stChatInfo* g_Chat = nullptr;
	struct stInputInfo* g_Input = nullptr;
